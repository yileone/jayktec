...
-->         
         ...
         */
         ...
         Gson gson = new Gson();
            ...
            String sqlQueryCountry="SELECT * FROM fateon.fateon_registro1 group by registro_date_1";
            ...
            */    
                ...
                lv.put("label", rsCountry.getString("registro_date_1"));
                lv.put("value", rsCountry.getString("registro_float_1"));
                lv.put("link", "newchart-json-" + rsCountry.getString("registro_id"));
                data.add(lv);
                ...
                linkedDataObj.put("id", rsCountry.getString("registro_id"));
               ...
               // The 'linkedChartAttribute' map object holds the chart attributes .
                ...
                linkedChartAttribute.put("caption" , "Top 10 Most Populous Cities - " + rsCountry.getString("registro_id") );
                ...
                // Form the SQL query that returns the top 10 most populous countries
                String sqlQueryCity="SELECT registro_id, registro_time_1, registro_date_1, registro_float_1 from fateon.fateon_registro1 WHERE registro_date_1 = ? ";

                // Prepare the query statement.
                PreparedStatement ptCity=con.prepareStatement(sqlQueryCity);  
                ptCity.setString(1, rsCountry.getString("registro_date_1"));
                // Execute the query.
                ResultSet rsCity=ptCity.executeQuery();
                while(rsCity.next()) {
                  Map<String, String> arrDara = new HashMap<String, String>();
                  arrDara.put("label", rsCity.getString("registro_time_1"));
                  arrDara.put("value", rsCity.getString("registro_float_1"));
            ...
            */    
            ...
            FusionCharts columnChart= new FusionCharts(
                    ...
                    "1000","600",            //width and height of the chart
